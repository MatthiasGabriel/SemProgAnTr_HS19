\begin{abstract}
There are certain classes of errors, which are hard to reason about in static code analysis and it's difficult and time consuming to manually write tests that cover every possibility.
