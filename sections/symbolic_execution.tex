...
\end{tikzpicture}
\end{adjustbox}
\caption{Example of a symbolic execution tree based on the function displayed in codesnippet \ref{codeSnippet:symbolicExecution}. For presentational reasons the tree skips the last two states after each assertion state, where the result is calculated and returned.}
...
\end{tikzpicture}
\end{adjustbox}
\caption{Partial symbolic execution tree related to codesnippet \ref{}. This is an addition to figure \ref{}.}
