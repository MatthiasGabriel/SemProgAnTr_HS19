...
\node[punkt] [rectangle split, rectangle split, rectangle split parts=4, text ragged] {
	 ...
	 child {
		 ...
		 child {
		        node[punkt] [rectangle split, rectangle split, rectangle split parts=1, text ragged] {
		            $\pi =  \alpha_a \geq 0 \land \alpha_b > 0 \land \highlight{\alpha_b < 0} \Leftrightarrow \text{not satisfiable}$
		        }
		        edge from parent
 		...
 		child {
			  ...
			  child {
			        node[punkt] [rectangle split, rectangle split, rectangle split parts=1, text ragged] {
				\textbf{$\highlight{\alpha_a+1 = 0} \land \alpha_a \geq 0 \land \alpha_b \leq 0 \land \alpha_b < 0 \land \alpha_b \geq 0 \Leftrightarrow false$}
			        }
		        edge from parent
 ...
 child {
        ...
        child {
	        node[punkt] [rectangle split, rectangle split, rectangle split parts=1, text ragged] {
		\textbf{$\highlight{(\alpha_a+1)*\alpha_b  = 0} \land  \alpha_a \geq 0 \land \alpha_b \leq 0 \land \alpha_b < 0 \Leftrightarrow false$}
	        }
        edge from parent
            node[kant, below, pos=.5] {}}
        edge from parent
        ...
        child {
	        node[punkt] [rectangle split, rectangle split, rectangle split parts=1, text ragged] {
		\textbf{$\highlight{\alpha_a  = 0} \land \alpha_a \geq 0 \land \alpha_b \leq 0 \land \alpha_b \geq 0 \Leftrightarrow true$}
	        }
        edge from parent
            node[kant, below, pos=.5] {}}
        edge from parent
...
child {
	 ...
	 child {
	        node[punkt] [rectangle split, rectangle split, rectangle split parts=1, text ragged] {
		\textbf{$\highlight{\alpha_a * -1 = 0} \land \alpha_a<0 \Leftrightarrow false$}
	        }
        edge from parent
            node[kant, below, pos=.5] {}}
        edge from parent
